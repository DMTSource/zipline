...
cpdef _compute_row_slices(dict asset_starts_absolute,
    ...
    cdef:
        ...
        # 1.) The index in the raw data of first row to load.
        # 2.) The index in the raw data of the last row to load.
        # 3.) The index in the **output buffer** to offset the loaded raw data.
        #     (This is non-zero iff the asset's lifetime begins partway
